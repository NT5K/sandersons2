      ...
      <section className="about-section">
        <div className="container">
          ...
          <div className="about-content">
            ...
            <p>
              This is not merely entertainment—it's a carefully crafted journey
              into a world where ancient mystique meets modern luxury, where
              every detail is designed to transport you beyond the ordinary into
              an evening of unforgettable theatrical magic.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="detail-grid">
            <div className="detail-card">
              ...
              <p>
                ...
                performance, and audience engagement bring Winifred, Sarah, and
                Mary to life with authenticity and theatrical flair.
              </p>
            </div>
            <div className="detail-card">
              <div className="detail-icon">
          ...
          <div className="company-grid">
            <div className="company-text">
              ...
              <p>
                ...
                creating immersive, emotionally effective life experiences that
              ...
              <p>
                ...
                combines theatrical artistry with sophisticated event production
                to deliver experiences that are both entertaining and
          ...
          <div className="highlight-list">
            <div className="highlight-item">
              ...
              <p>
                ...
                audiences, featuring themes and interactions that resonate with
                adult sensibilities.
              </p>
            </div>
            <div className="highlight-item">
              ...
              <p>
                Every performer is professionally trained, ensuring consistent,
                high-caliber entertainment that meets the expectations of
                discerning guests.
              </p>
            </div>
            <div className="highlight-item">
              ...
              <p>
                While honoring the beloved source material, we expand and deepen
                the story, creating new moments and revelations that surprise
                even devoted fans.
              </p>
            </div>
            <div className="highlight-item">
              ...
              <p>
                Historical research informs every design choice, from costuming
                to set pieces, creating an authentic period atmosphere that
                enhances immersion.
              </p>
            </div>
            <div className="highlight-item">
              ...
              <p>
                Limited audience size ensures intimate interaction opportunities
                and premium service that larger productions cannot provide.
              </p>
            </div>
            <div className="highlight-item">
              <h4>Memorable Moments</h4>
              <p>
                Carefully orchestrated surprises and interactive elements ensure
                every guest leaves with unique, personal memories of their
