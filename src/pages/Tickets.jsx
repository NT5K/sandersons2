  ...
  const faqData = [
    {
      ...
      answer: "You'll be transported into the world of the Sanderson Sisters through immersive storytelling, live performance, interactive spell-casting, and atmospheric entertainment. The experience combines theater, cocktails, and audience participation in an intimate, candlelit setting that brings the magic of Salem to life."
    },
    {
      question: "Is there a dress code?",
      answer: "We recommend cocktail attire for the sophisticated atmosphere. Costumes are welcomed and encouraged—many guests enjoy dressing as witches, in period attire, or Halloween-themed outfits. However, costumes are entirely optional, and elegant evening wear is equally appropriate."
    },
    {
      question: "Are there dietary accommodations available?",
      answer: "Yes, we accommodate various dietary restrictions including vegetarian, vegan, gluten-free, and other allergies. Please inform us of any dietary needs when making your reservation, and our culinary team will ensure appropriate alternatives are prepared."
    },
    {
      question: "Can I purchase tickets as gifts?",
      answer: "Absolutely! Our experience makes an exceptional gift. Gift certificates are available for all package levels and can be purchased for specific dates or as open-ended vouchers. Digital gift certificates can be delivered immediately via email with custom messaging."
    },
    {
      question: "What is your cancellation policy?",
      answer: "Cancellations made 7+ days before the event receive a full refund. Cancellations 3-6 days prior receive a 50% refund. Cancellations within 48 hours are non-refundable, though we offer date transfers subject to availability. We understand plans change and work with guests when possible."
    },
    {
      question: "Is photography allowed during the show?",
      answer: "Photography is welcome during designated moments and intermissions. We provide guided photo opportunities with the Sisters and sets. Flash photography is not permitted during performances to maintain the atmospheric lighting and respect for other guests' immersion."
    }
  ];
    ...
    <div>
      ...
      <section className="ticket-packages">
        <div className="container">
          ...
          <p className="section-subtitle">Choose your level of enchantment for an unforgettable evening in Salem</p>
          ...
          <div className="package-grid" id='packages'>
            ...
            <div className="package-card">
              ...
              <a href="#contact" className="package-button">Select Package</a>
            </div>
        ...
        <div className="container">
          ...
          <div className="details-grid">
            <div className="detail-info-card">
              ...
              <h3>Schedule</h3>
              <p><strong>October 12-31, 2025</strong><br />
              Fridays & Saturdays: 7:00 PM<br />
              Special Halloween Shows: Oct 29-31<br />
              Duration: 2.5 hours</p>
            </div>
            <div className="detail-info-card">
              <div className="detail-info-icon">
              ...
              <h3>Venue</h3>
              <p><strong>The Salem Sanctuary</strong><br />
              Historic venue in downtown Salem<br />
              Intimate 60-seat capacity<br />
              Full accessibility accommodations</p>
            </div>
            <div className="detail-info-card">
              <div className="detail-info-icon">
              ...
              <h3>Requirements</h3>
              <p><strong>21+ Event</strong><br />
              Valid photo ID required<br />
              Cocktail attire recommended<br />
              Costumes encouraged but optional</p>
            </div>
            <div className="detail-info-card">
              <div className="detail-info-icon">
              ...
              VIP packages include valet service</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="private-content">
            <div className="private-text">
              ...
              <p>Transform your special occasion into an unforgettable theatrical experience. Whether celebrating a birthday, bachelorette party, corporate event, or intimate gathering, the Sanderson Sisters can be exclusively yours.</p>
              
              <p>Our private events offer complete customization of the experience, from personalized interactions to custom cocktail menus that reflect your group's preferences.</p>
              ...
              <a href="#contact" className="btn-luxury">Inquire About Private Events</a>
            </div>
            <div className="private-image">
              <img src="https://images.unsplash.com/photo-1445262102387-5fbb30a5e59d?w=600&h=400&fit=crop" 
          ...
          <div className="faq-container">
            {faqData.map((faq, index) => (
              <div key={index} className={`faq-item ${activeFaq === index ? 'active' : ''}`}>
                ...
                >
                  {faq.question}
                  <i className={`fas fa-plus faq-icon ${activeFaq === index ? 'active' : ''}`}></i>
                </button>
        ...
        <div className="container">
          <div className="text-center">
            ...
            <p className="section-subtitle" style={{maxWidth: '600px', margin: '0 auto 50px'}}>
              Join us for an evening where Salem's most legendary witches come to life in an unforgettable theatrical experience designed for the sophisticated adult audience.
            </p>
            <div className="cta-buttons">
              <a href="#contact" className="btn-luxury">Book Your Experience</a>
              <a href="#contact" className="btn-luxury">Contact for Private Events</a>
            </div>
          </div>
        </div>
      </section>
